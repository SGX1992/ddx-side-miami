import { EVENTS } from './events.js?v=20260913002328';
import { SUBMIT_ENDPOINT, POSTER_URL } from './config.js?v=20260913002328';
import { VIP, MIAMI, SITE, CITY, COPY } from './variant.js?v=20260913002328';
import { cardHTML } from './render.js?v=20260913002328';
...
const ALL = MIAMI
  ? (await import('./events-miami.js?v=20260913002328')).MIAMI_EVENTS
  : VIP ? [...(await import('./events-vip.js?v=20260913002328')).VIP_EVENTS, ...EVENTS] : EVENTS;
